...
Му уверены что если возможно обойтись полем в одной таблице нужно поступать именно так. Мы считаем что это дает более широкие возможности (хранить несколько описаний товара или несколько цен), а также не сильно уступает по скорости доступа чем запрос `description_id`
