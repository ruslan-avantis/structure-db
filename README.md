...
Проектирование структуры базы данных важнейшая задача при создании любой CMS. Максимальная скорость доступа к данным и минимальное количество полей в самых запрашиваемых таблицах.
- Пример: 1 числовое поле в таблице с 1 млн. записей может занимать более 50 Мб.
...
## База состоит из 23 основных таблиц
#### Глобальные
