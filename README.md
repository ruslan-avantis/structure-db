# db.json — Структура баз данных под стандарт «APIS-2018»
...
## Вышла [1.0.1-BETA-1](https://github.com/pllano/structure-db/releases)
В нашем первом релизе [`1.0.1-BETA-1`](https://github.com/pllano/structure-db/releases) проработаны 24 основные ресурса (таблицы). Минимальный набор для легкого интернет-магазина.
