...
В нашем первом релизе [`1.0.1-BETA-3`](https://github.com/pllano/structure-db/releases) проработаны 24 основные ресурса (таблицы). Минимальный набор для легкого интернет-магазина.
